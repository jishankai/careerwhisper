...
class CreditsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create credit" do
    assert_difference('Credit.count') do
      post credits_url, params: { credit: { score: @credit.score, student_id: @credit.student_id } }
    end
  ...
  test "should update credit" do
    patch credit_url(@credit), params: { credit: { score: @credit.score, student_id: @credit.student_id } }
