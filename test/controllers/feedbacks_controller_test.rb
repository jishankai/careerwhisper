...
class FeedbacksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create feedback" do
    assert_difference('Feedback.count') do
      post feedbacks_url, params: { feedback: { description: @feedback.description, user_id: @feedback.user_id } }
    end
  ...
  test "should update feedback" do
    patch feedback_url(@feedback), params: { feedback: { description: @feedback.description, user_id: @feedback.user_id } }
